...
Imath::Box2i roundBox( const Imath::Box<Imath::Vec2<T> >& b, bool round_up = false)
{
    ...
    if( round_up)
    {
        return Imath::Box2i( Imath::V2i( Imath::Math<T>::floor( b.min.x), Imath::Math<T>::floor( b.min.y)),
                      Imath::V2i( Imath::Math<T>::ceil( b.max.x) , Imath::Math<T>::ceil( b.max.y)));
    }
    else
    {
        return Imath::Box2i( Imath::V2i( Imath::Math<T>::ceil( b.min.x) , Imath::Math<T>::ceil( b.min.y)),
...
RAMEN_API Imath::Box2i transform( const Imath::Box2i& box, const Imath::M33f& m, bool round_up = false);
RAMEN_API Imath::Box2i transform( const Imath::Box2i& box, const Imath::M33d& m, bool round_up = false);
...
RAMEN_API Imath::Box2f scale( const Imath::Box2f& b, float sx, float sy, float xcenter, float ycenter);
