...
typedef boost::gil::memory_based_2d_locator<boost::gil::memory_based_step_iterator<rgb_pixel_ptr_t> >	rgb_locator_t;
...
typedef boost::gil::memory_based_2d_locator<boost::gil::memory_based_step_iterator<const_rgb_pixel_ptr_t> >     const_rgb_locator_t;
...
typedef boost::gil::memory_based_2d_locator<boost::gil::memory_based_step_iterator<rgb_pixel_step_ptr_t> >	rgb_step_locator_t;
...
typedef boost::gil::memory_based_2d_locator<boost::gil::memory_based_step_iterator<const_rgb_pixel_step_ptr_t> >    const_rgb_step_locator_t;
